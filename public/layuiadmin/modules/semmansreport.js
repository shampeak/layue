  ...
  ,form = layui.form;
    ...
    table.render({
        ...
        ,cols: [[
            ...
            ,{field: 'ustitle', title: '人员', minWidth:80 , fixed: 'left',style:'background-color: #2F4056;color:#fff'}
            ...
            //,{field: 'ctr', title: 'CTR'}
//            ,{title: '状态',width: 100,fixed: 'right',toolbar: '#table-admin-status' }
        ]]

        //,{field: 'xingjiabi', title: '性价比', width: 100}
